# AxeBCH ATH Watcher - Umbrel App Store

Custom Umbrel app store containing the AxeBCH ATH Watcher app.

## 🚀 What This App Does

Monitors your AxeBCH mining pool workers and automatically sends a beautiful Discord notification whenever any worker achieves a new all-time best share. 
...
5. Enter this repository URL:
   ```
   https://github.com/YOUR_USERNAME/axebch-ath-watcher-umbrel
   ```
6. Click **Add**
7. Find "AxeBCH ATH Watcher" in your Community App Stores
8. Click **Install**
9. Open the app and configure your Discord webhook URL
